...
public class Main {
    ...
    public static void lerFaturamento(String arquivo){
        String csvSeparador = ",";
        String line;
        ...
        imprimirLinha(80);
        imprimirCentralizado("Faturamento Semanal", 80);
        imprimirLinha(80);
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(caminhoDoarquivo))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (verificarData(columns[1]) == true) {
                    ...
                    imprimir("Funcionario: " + columns[0] + " | Data: " + columns[1] + " | Serviço: " + columns[2] + " | Preço: R$" + columns[3]);
            ...
            if(verificarEvento == false){
                imprimirCentralizado("Ainda não há faturamento registrado para esta semana", 80);
                imprimirLinha(80);
            }else{
                imprimirLinha(80);
                imprimirCentralizado("Total: R$" + valorTotal, 80);
                imprimirLinha(80);
            }
        }
        catch (IOException e) {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, InformacaoInvalida {
        ...
        while (true) {
            imprimirLinha(50);
            imprimirCentralizado("Bem-Vindo ao seu Pet Shop:", 50);
            imprimirLinha(50);
            Funcionario funcionario = autenticar(funcionarios);

            menu:
            while (true) {
                imprimirLinha(50);
                imprimirCentralizado("Bem-Vindo " + funcionario.getNome(), 50);
                imprimirLinha(50);
                imprimir("1-Sair");
                imprimir("2-Cadastrar Cliente");
                imprimir("3-Cadastrar Pet");
                imprimir("4-Visualizar Registro do Cliente");
                imprimir("5-Visualizar Registro do Pet");
                imprimir("6-Calcular Salário Semanal");
                imprimir("7-Registrar Serviço");
                imprimir("8-Visualizar Serviços Registrados");
                imprimir("9-Cadastrar Veterinário");
                imprimir("10-Cadastrar Ajudante");
                imprimir("11-Visualizar Faturamento Semanal");
                imprimirLinha(50);
                switch (solicitarInt("Digite o número da opção que quer acessar: ")) {
                    case 1:
                        break menu;
                    case 2:
                        funcionario.cadastrarCliente(pessoas, clientes);
                        break;
                    case 3:
                        funcionario.cadastrarAnimal(clientes, pets);
                        break;
                    case 4:
                        visualizarCliente(funcionario.visualizarCliente(clientes), pets);
                        break;
                    case 5:
                        funcionario.visualizarAnimal(pets);
                        break;
                    case 6:
                        funcionario.calcularSalario(solicitarInt("Digite suas horas faltadas: "), solicitarInt("Digite suas horas extras: "));
                        break;
                    case 7:
                        eventos.add(funcionario.criarEvento(funcionarios, pets));
                        break;
                    case 8:
                        funcionario.visualizarEventos();
                        break;
                    case 9:
                        funcionario.cadastrarVeterinario(pessoas, funcionarios);
                        break;
                    case 10:
                        funcionario.cadastrarAjudante(pessoas, funcionarios);
                        break;
                    case 11:
                        salvarFaturamento(eventos, "faturamento.csv");
                        lerFaturamento("faturamento.csv");
                        break;
                    default:
                        imprimir("Opcão não encontrada!\nTente Novamente!");
                        break;
            ...
            imprimirLinha(50);
            imprimir("1-Sair do Sistema");
            imprimir("2-Identificar-se Novamente");
            if (solicitarInt("Digite o número da opção que quer acessar: ") == 1) {
                break;
            }
        }
        imprimirLinha(50);
        imprimir("Salvando os dados...");
        //Salvar os objts
        ...
        imprimirLinha(50);
        imprimirCentralizado("Obrigado por usar o Sistema!", 50);
    }
}